...
Sanja is a Senior Lecturer and convenor on the courses [HDAT9100](../courses.html#hdat9100) Context for Health Data Science and [HDAT9400](../courses.html#hdat9400) Data Management & Curation.<br><br> {{< fa envelope title="An envelope" >}} <a href="mailto:s.lujic@unsw.edu.au">s.lujic@unsw.edu.au</a>
:::
